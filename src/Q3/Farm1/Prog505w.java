...
public class Prog505w {
    public static void main(String[] args) {
        try {
            Scanner input = new Scanner(new File("Langdat/prog505w.dat")); // remember to replace with new data file
...
/*
The total income for the day is: -178.82999999999987
The total weight of all the animals is: 32790
There is 215 left and 330 left. So there is enough food to feed all animals
Cow Debby makes the most amount of money
Horse MarkMark makes the least amount of money
 */