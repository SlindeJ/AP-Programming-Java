package CodeSpaces.Q1.Prog213bCL;
...
public class Prog213b {
    public static void main(String[] args) {
        try {
            Scanner input = new Scanner(new File("Langdat/Prog213b.txt")); // remember to replace with new data file
            int qnt = 0;
